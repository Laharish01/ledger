      ...
      <div class="modal">
        ...
        <div class="field">
          ...
          <div class="type-toggle">
            <button class="type-opt" :class="{ active: true, expense: type === 'expense' }" @click="type = 'expense'">Expense</button>
            <button class="type-opt" :class="{ active: type === 'income', income: type === 'income' }" @click="type = 'income'">Income</button>
          </div>
        </div>

        <div class="field">
          <label>Amount</label>
          <input type="number" v-model="amount" min="0" step="0.01" placeholder="0.00">
        </div>

        <div class="field">
          <label>Category</label>
          <input type="text" v-model="category" placeholder="Food">
        </div>
        ...
        <div class="modal-actions">
          ...
          <button class="modal-btn primary" @click="save">Save Changes</button>
        </div>
      </div>
    </div>
  </Teleport>
